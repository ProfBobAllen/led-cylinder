...
def demoLoop(strip):
    try:
        ...
        while True:
            spinBarberPole2(strip,colorWhite,colorOrange)
            print('POUR COLOR Drop white blue')
            pourColorDown(strip,colorWhite,colorBlue)
            print('GROW COLOR Up green white')
            growColorUp(strip,colorBlue,colorWhite)
            print('snow')
            snow(strip,colorWhite,colorBlue)
            #print('blue cylinder')
            #setCylinderColor(strip, colorBlue)
            print('wrapColor Red')
            wrapColor(strip, colorRed);
            print('wrapColor  White')
            wrapColor(strip, colorWhite);
            print('wrapColor  Blue')
            wrapColor(strip, colorBlue);
            print('wrap bars of two colors blue and green')
            wrap2Colors(strip,colorBlue,colorGreen)
            print('wrap bars of two colors Yellow and Green')
            wrap2Colors(strip,colorYellow,colorGreen)
            print('wrap bars of two colors Black and White')
            wrap2Colors(strip,colorBlack,colorWhite)
            print('spin bars of two colors White and Black')
            spin2Colors(strip,colorBlack,colorWhite)
            print('spin Barber Pole w/6 panels')
            spinBarberPole(strip,colorYellow,colorPurple)
            print('falling bars Orange and White')
            setCylinderColor(strip, colorWhite)
            fallingBars(strip,colorWhite,colorOrange)
            setCylinderColor(strip,colorBlue)
            displayDots(strip,colorWhite,colorBlue)
...
if __name__ == '__main__':
    cmmds = ["barber", "blue", "red", "white","snow"]
    # Process arguments
    ...
    if newPid == 0:
        demoLoop(strip)
        print("doing demo loop")
    else:
        while True:
            #print("press Enter to input...")
            #input()
            print("THIS IS PROCESS " + str(os.getpid()))
            ...
            print("you said: " + text)
            text = text.lower()
            if any(word in text.split() for word in cmmds):
                print("killing " + str(newPid))
